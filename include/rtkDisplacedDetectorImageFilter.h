...
#if defined(RTK_USE_CUDA) && !defined(ITK_TEMPLATE_EXPLICIT_DisplacedDetectorImageFilter)
...
extern template class RTK_EXPORT_EXPLICIT DisplacedDetectorImageFilter<itk::CudaImage<float, 3>, itk::CudaImage<float, 3>>;
