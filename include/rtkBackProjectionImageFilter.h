...
#if defined(RTK_USE_CUDA) && !defined(ITK_TEMPLATE_EXPLICIT_BackProjectionImageFilter)
...
//#endif
    extern template class RTK_EXPORT_EXPLICIT BackProjectionImageFilter<itk::CudaImage<float, 3>, itk::CudaImage<float, 3>>;
