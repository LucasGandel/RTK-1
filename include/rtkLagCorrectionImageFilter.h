...
//#if defined(RTK_USE_CUDA) && !defined(ITK_TEMPLATE_EXPLICIT_LagCorrectionImageFilter)
...
//
//    extern template class RTK_EXPORT_EXPLICIT LagCorrectionImageFilter<itk::CudaImage<float, 3>, 4>;
//
