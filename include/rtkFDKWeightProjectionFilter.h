...
#if defined(RTK_USE_CUDA) && !defined(ITK_TEMPLATE_EXPLICIT_FDKWeightProjectionFilter)
...
extern template class RTK_EXPORT_EXPLICIT FDKWeightProjectionFilter<itk::CudaImage<float, 3>, itk::CudaImage<float, 3>>;
